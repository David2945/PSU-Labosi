...
print("Najveca cijena: ", df.max().selling_price)
print("Najmanja cijena: ", df.min().selling_price)

#4. Koliko automobila je proizvedeno 2012. godine?
print("Proizvedeni 2012 godine", df[(df.year == 2012)])

#5. Koji automobil je prešao najviše kilometara, a koji najmanje?
print("Najvise km: ", df.max().km_driven)
print("Najmanje km: ", df.min().km_driven) 
